...
function showReviewModal(taskId, taskTitle) {
    // Copy Task Details is for Admin (1) and Supervisor (3) only
    const canCopy = typeof role !== 'undefined' && ['1', '3'].includes(String(role));
    ...
    modal.innerHTML = `
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-2xl p-6 max-w-lg w-full mx-4">
            <div class="flex items-start justify-between gap-3 mb-4">
                <h3 class="text-xl font-bold text-gray-800 dark:text-white">Review Task</h3>${copyButton}
            </div>
