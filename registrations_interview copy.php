        ...
        `);
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            // Keep interview info in name column for context since we removed the dedicated column
            ...
            function openRescheduleModal(row) {
                ...
                if (row.interview_start && row.interview_end) {
                    ...
                    // Set times
                    const startStr = startDate.toTimeString().slice(0, 5);
            ...
            $(document).on('click', '#viewModal .reject-btn', async function(e) {
                e.preventDefault();
                e.stopPropagation();
                ...
                if (!row) {
                    showToast('error', 'Unable to load candidate data.');
                    return;
                }

                if (!confirm(`Are you sure you want to reject ${row.name}?`)) return;
                ...
                try {
                    ...
                    if (json.success) {
                        ...
                        $('#viewModal').addClass('hidden'); // Close modal
                        table.ajax.reload();
                    } else {
                        showToast('error', json.message);
                    }
            ...
            // Reject - Direct rejection without modal
