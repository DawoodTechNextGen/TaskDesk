                        ...
                        <table id="supervisorsTable" class="min-w-full">
                            <thead class="bg-indigo-200 dark:bg-indigo-600">
                                <tr>
                                    ...
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-700 dark:text-gray-200 uppercase tracking-wider">Commission Rate (PKR)</th>
    ...
    <div id="supervisor-modal" class="modal hidden fixed inset-0 z-50 bg-black bg-opacity-50 backdrop-blur-sm flex items-center justify-center">
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-11/12 max-w-md p-6">
            ...
            <form id="supervisor-form">
                ...
                <div class="mb-4">
                    <label class="block text-sm font-medium mb-1 text-gray-900 dark:text-gray-100">Commission Rate (PKR)</label>
                    <input type="number" name="commission_rate" min="0" required class="w-full px-3 py-2 border rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100" placeholder="1000">
                </div>
                <div class="mb-4">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            document.addEventListener('click', e => {
                ...
                document.querySelector('[name="commission_rate"]').value = editBtn.dataset.commissionRate || '1000';
