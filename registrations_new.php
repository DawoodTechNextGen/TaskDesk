...
$(document).ready(function() {
    ...
    $(document).on('click', '.update-btn', async function() {
        ...
        if (status === 'contact_email') {
            if (!confirm('Are you sure you want to contact this candidate by email? A predefined template email will be sent automatically.')) return;
        ...
        try {
            ...
            if (status === 'contact_whatsapp') {
                formData.append('contact_via', 'whatsapp');
            }
