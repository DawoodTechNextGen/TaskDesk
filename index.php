...
if ($user_role == 1) {
    ...
    $is_internship_completed = isInternshipDurationCompleted($conn, $user_id);
} elseif ($user_role == 3) {
    // Supervisor data
...
<body class="bg-gray-50 dark:bg-gray-900 transition-colors">
    <?php if ($user_role == 2 && !empty($is_internship_completed)): ?>
    <!-- Internship Completed Modal Popup -->
    <div id="internship-completed-modal" class="fixed inset-0 z-[99999] flex items-center justify-center p-4 bg-gray-900/80 backdrop-blur-md transition-all duration-300">
        <div class="relative w-full max-w-lg bg-white dark:bg-gray-800 rounded-3xl shadow-2xl border border-emerald-100 dark:border-emerald-900/50 p-6 md:p-8 text-center overflow-hidden transform transition-all scale-100">
            ...
            <div class="mx-auto w-20 h-20 mb-5 rounded-full bg-emerald-100 dark:bg-emerald-900/40 text-emerald-600 dark:text-emerald-400 flex items-center justify-center text-4xl shadow-inner animate-bounce">
                🎓
            </div>
            
            <h3 class="text-2xl md:text-3xl font-extrabold text-gray-900 dark:text-white mb-3 tracking-tight">
                Internship Completed!
            </h3>
            
            <p class="text-base text-gray-600 dark:text-gray-300 mb-4 leading-relaxed">
                Congratulations! Your internship duration has been successfully completed.
            </p>
            
            <div class="bg-emerald-50 dark:bg-emerald-950/40 rounded-2xl p-4 border border-emerald-200 dark:border-emerald-800/60 mb-6 text-left">
                <div class="flex items-start space-x-3">
                    ...
                    <div>
                        <p class="text-sm font-semibold text-emerald-900 dark:text-emerald-200">Completion Certificate</p>
                        <p class="text-xs text-emerald-700 dark:text-emerald-300 mt-1">
                            Contact with our manager on WhatsApp for certificate.
                        </p>
                        <p class="text-sm font-bold text-emerald-800 dark:text-emerald-300 mt-2">
                            WhatsApp: <span class="font-mono text-emerald-900 dark:text-emerald-100">03117305346</span>
                        </p>
                    </div>
                </div>
            </div>

            <a href="https://api.whatsapp.com/send?phone=923117305346&text=Assalam-o-Alaikum%2C%20I%20have%20completed%20my%20internship%20duration.%20Please%20provide%20my%20certificate." target="_blank" rel="noopener noreferrer" class="inline-flex items-center justify-center w-full px-6 py-3.5 text-base font-semibold text-white bg-emerald-600 hover:bg-emerald-700 active:bg-emerald-800 rounded-xl shadow-lg hover:shadow-emerald-500/25 transition-all duration-200 group">
                <svg class="w-6 h-6 mr-2 fill-current group-hover:scale-110 transition-transform" viewBox="0 0 24 24">
